...
print("PRECEDÊNCIA DE OPERAÇÕES: ")
print(10-5*2)#0
print((10-5)*2)#10
print(10**2*2)#200
print(10**(2*2))#10000
...
"""Operadores lógicos: são operadores utilizados em conjunto com os operadores de comparação, para montar uma expressão lógica.
Quando um operador de comparação é utilizado, o resultado retornado é um booleano, dessa forma podemos combinar operadores de 
